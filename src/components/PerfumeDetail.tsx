...
export function PerfumeDetail({
  ...
  return (
    <section id="perfumeria" className="grid grid-cols-1 lg:grid-cols-12 gap-8 scroll-mt-24">
      ...
      <div
        className="lg:col-span-8 glass-card p-6 sm:p-8 rounded-2xl flex flex-col justify-between border border-[var(--color-luxury-gold)]/20 shadow-2xl relative overflow-hidden"
